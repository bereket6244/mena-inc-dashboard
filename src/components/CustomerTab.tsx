          ...
          >
            ...
            >
              <div className="p-4 border-b border-gray-200 dark:border-[#333] flex items-center justify-between bg-gradient-to-r from-gray-50 to-white dark:from-[#1a1a1a] dark:to-[#111]">
                ...
                <button onClick={() => setManagingPaymentsFor(null)} className="text-gray-400 hover:text-gray-700 dark:hover:text-white transition-colors cursor-pointer">
                  <X className="w-5 h-5" />
                </button>
              </div>
              <div className="p-4 overflow-y-auto max-h-[60vh] custom-scrollbar">
                ...
                <div className="border-t border-gray-200 dark:border-[#333] pt-4 mt-2">
                  ...
                  <div className="space-y-3">
                    <div>
                      <label className="block text-[10px] uppercase text-gray-600 dark:text-gray-500 mb-1">Amount ({managingPaymentsFor.currency || 'ETB'})</label>
                      <input
                        type="number"
              ...
              <div className="p-4 border-t border-gray-200 dark:border-[#333] bg-gray-50 dark:bg-[#0a0a0a] flex justify-between gap-2">
                <button
                  onClick={() => {
                  ...
                  className="px-3 py-2 text-xs font-bold text-gray-600 dark:text-gray-400 border border-gray-300 dark:border-gray-600 hover:text-gray-900 dark:hover:text-white hover:bg-gray-200 dark:hover:bg-gray-800 rounded transition-colors flex items-center gap-1 cursor-pointer"
                >
        ...
        {managingAdjustmentsFor && (
          ...
          >
            ...
            >
              ...
              <div className="p-4 overflow-y-auto max-h-[60vh] custom-scrollbar">
                <div className="mb-4">
                  <h4 className="text-xs font-bold text-gray-500 dark:text-gray-400 uppercase tracking-wider mb-2">Previous Adjustments</h4>
                  {managingAdjustmentsFor.orderAdjustments && managingAdjustmentsFor.orderAdjustments.length > 0 ? (
                    <div className="space-y-2">
                      {managingAdjustmentsFor.orderAdjustments.map((adj, idx) => (
                        <div key={idx} className="flex justify-between items-center bg-white dark:bg-[#1a1a1a] p-2 rounded border border-gray-200 dark:border-[#2a2a2a]">
                          <div>
                            <div className="text-gray-900 dark:text-white text-xs font-bold">+{adj.additionalQuantity} qty @ {Number(adj.unitPrice).toLocaleString()}</div>
                ...
                <div className="border-t border-gray-200 dark:border-[#333] pt-4 mt-2">
                  ...
                  <div className="space-y-3">
                    <div className="grid grid-cols-2 gap-3">
                      <div>
                        <label className="block text-[10px] uppercase text-gray-600 dark:text-gray-500 mb-1">Additional Qty</label>
                        <input
                          type="number"
                      ...
                      <div>
                        <label className="block text-[10px] uppercase text-gray-600 dark:text-gray-500 mb-1">Unit Price ({managingAdjustmentsFor.currency || 'ETB'})</label>
                        <input
                          type="number"
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      ...
                      <div>
                        <label className="block text-[10px] uppercase text-gray-600 dark:text-gray-500 mb-1">Notes (Optional)</label>
                        <input
                          type="text"
