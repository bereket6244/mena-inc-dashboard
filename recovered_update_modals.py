                              ...
                              {!isLegacy && (
                                <>
                                  <button onClick={() => {
                                    ...
                                    setNewPaymentMethodId(p.paymentMethodId);
                    ...
                    onClick={() => {
                      ...
                      if (editingPaymentId) {
                        updatedPayments = managingPaymentsFor.payments.map(p => 
                          p.id === editingPaymentId ? { ...p, amount: Number(newPaymentAmount), date: newPaymentDate, paymentMethodId: newPaymentMethodId } : p
                        );
